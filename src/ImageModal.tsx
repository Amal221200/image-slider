...
const ImageModal = () => {
    ...
    return (
        <div id="image-modal" className={`absolute overflow-hidden inset-0 w-full h-full bg-black/70 justify-center items-center ${open ? 'flex' : 'hidden'}`}>
            ...
            <div className="flex h-full flex-col justify-between space-y-2 px-3 pb-3">
                <div />
                <div className="mx-auto max-w-xs px-8 sm:max-w-md md:max-w-xl lg:max-w-3xl" key={openedImage}>
                ...
                <div className="scrollbar mx-auto flex w-full flex-row gap-2 overflow-x-auto px-4 sm:max-w-xl">
                    {
